...
public class SettingActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        saveId = findViewById(R.id.switch1);
        ...
        saveId.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                new AppPreferences(getApplicationContext()).setStringPref(AppPreferences.KEY_CHECKED_BUTTON_ACCOUNT, isChecked);
            }
        });

        autoLogin = findViewById(R.id.switch2);
...
//                Toast.makeText(SettingActivity.this, "today", Toast.LENGTH_SHORT).show();
                ...
                Intent intent = new Intent(SettingActivity.this, ExerciseActivity.class);
...
//                Toast.makeText(SettingActivity.this, "record", Toast.LENGTH_SHORT).show();
                ...
                Intent intent = new Intent(SettingActivity.this, HistoryCalendarActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
                finish();
            }
