...
import com.bpm202.SensorProject.Main.Schedules.PlanAddActivity;
import com.bpm202.SensorProject.Main.Schedules.PlansViewPagerFragment;
...
//        inflater.inflate(R.menu.schedules_edit_menu, menu);
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        Log.d("Test", "onCreateOptionsMenu menu : " + menu);
...
//                SchdulesManager.Instance().setSTATE(SchdulesManager.STATE.DEFAULT);
                break;*/
//            case R.id.menu_add:
//                startActivity(new Intent(getActivity(), PlanAddActivity.class));
//                break;
